// TypeScript definitions for OmniFocus 4.8.5 (185.3) on macOS 15.6.1
// Generated on 2025-10-29 19:45:09 +0000
...
declare namespace Document {
  ...
  function makeNewAndShow(
    resultFunction: (document: Document | Error) => void | null
  ): Promise<Document>;
}
...
declare class FileWrapper {
  ...
  write(
    url: URL,
    options: Array<FileWrapper.WritingOptions> | null,
    originalContentsURL: URL | null
  ): void;
...
declare namespace LanguageModel.Session {
  function withTools(
    tools: Array<_omnijs_AnonymousProxy>,
...
declare class URL {
  ...
  call(
    ...
    failure: (...args: unknown[]) => unknown | null
  ): void;
  open(): void;
...
declare namespace XML {
  class Document {
    constructor(
      rootElement: string | XML.Element,
      configuration: XML.Document.Configuration | null
    );
    xmlData(): Data;
